...
All version information is stored in **one location**: the top of `icloud_downloader.py`
...
Edit **one file only**: `icloud_downloader.py`
...
| File | What to Update |
|------|----------------|
| `icloud_downloader.py` | Line ~35: `__version__ = "X.Y.Z"` |
| `README.md` | Line 5: Version badge number |
| `CHANGELOG.md` | Add new version section at top |

**Remember:** Change the version in `icloud_downloader.py` first, everything else references it!
